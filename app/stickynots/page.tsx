...
const Sticky = () => {
    ...
    return (
        <div> 
            ...
            <div className='w-full h-full p-4 gap-5 flex-wrap'>
                {state.notes.map( (note:any)=> <Nots data={note}/> )}
                <div className=' w-52 h-52 flex items-center justify-center bg-background2 hover:opacity-80 transition-opacity cursor-pointer relative before:absolute before:bg-background2 before:w-3 before:h-3 before:top-0 before:right-0 before:shadow-lg overflow-hidden' onClick={onOpen}>
